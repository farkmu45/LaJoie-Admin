...
$submission = Submission::get($_GET['id']);
...
<head>
  ...
  <title>Manajemen Submission &rsaquo; Detail &mdash; LaJoie</title>
              ...
              <div class="col-12">
                <div class="card author-box card-primary">
                  <div class="card-body">
                    ...
                    <!-- KONTEN -->
                    <div class="author-box-left" style="width: 100px; height: 100px; overflow: hidden;">
                      <img alt="image" style="width: 100px; height: 100px; object-fit:cover" src="<?= $submission['document'] ? StringUtil::getImage($submission['document']) : 'assets/img/avatar/avatar-1.png' ?>" class="rounded-circle author-box-picture">
                      <div class="clearfix"></div>
                    </div>
                    <div class="author-box-details">
                      <div class="author-box-name">
                        <a href="#"> <?= $submission['name'] ?></a>
                      </div>
                      ...
                      <div class="card-body">
                        ...
                        <div class="chocolat-parent">
                          <a href="assets/img/example-image2.jpg" class="chocolat-image" title="Just an example">
                            <div data-image="150">
                              <img alt="image" src=" <?= StringUtil::getImage($submission['document']) ?>" class="img-fluid">
                            </div>
                          </a>
                        </div>
                      </div>
                      <div class="text-time"> <?= $submission['username'] ?> || <?= $submission['created_at_gmt'] ?></div>
                    </div>
                  </div>
                </div>
              </div>
