...
<head>
  ...
  <title>Wall &rsaquo; <?= StringUtil::limit($wall['title'], 10) ?> &mdash; LaJoie</title>
              ...
              <div class="card">
                <div class="card-body">
                  <ul class="
                      ...
                      ">
                    <li class="media">
                      <img alt="image" class="mr-3 rounded-circle" width="70" src="<?= empty($wall['picture']) ?  'assets/img/avatar/avatar-1.png' : StringUtil::getImage($wall['picture'])  ?>" />
                      <div class="media-body">
                        <div class="media-right">
                          <div class="text-primary"><?= $wall['status'] ?></div>
                        </div>
                        <div class="media-title mb-1"><?= $wall['username'] ?></div>
                        <div class="text-time"><?= $wall['created_at_gmt'] ?></div>
                        <div class="media-title text-muted">
                          <?= $wall['title'] ?>
                        </div>
