...
if ($_POST) {
  ...
  $name = $_POST['name'];
  $password = empty($_POST['password']) ? $_SESSION['adminPassword'] : password_hash($_POST['password'], PASSWORD_BCRYPT);


  if (Admin::update($_SESSION['adminId'], $name, $username, $password)) {
...
<head>
  ...
  <title><?= $_SESSION['adminUsername'] ?> &mdash; LaJoie</title>
      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Hi, <?= $_SESSION['adminName'] ?>!</h2>
                    ...
                    <form method="POST">
                      <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <input type="text" name="name" class="form-control" value="<?= $_SESSION['adminName'] ?>" required />
                        </div>
                      </div>
                      <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Username</label>
                        <div class="col-sm-12 col-md-7">
                          <input type="text" name="username" class="form-control" value="<?= $_SESSION['adminUsername'] ?>" required />
                        </div>
                      </div>
                      <div class="form-group row mb-4">
