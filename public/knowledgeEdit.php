...
if ($_POST) {
  ...
  if (Knowledge::editDetail($knowledgeId, $name, $text)) {
    header("Location: knowledgeDetail.php?id=$knowledgeId");
  }
}
...
<head>
  ...
  <title><?= $knowledge['name'] ?> - Edit &mdash; LaJoie</title>
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">
                <a href="knowledgeList.php?category_id=<?= $knowledge['category_id'] ?>&name=<?= StringUtil::encodeUrl($knowledge['category']) ?>"><?= $knowledge['category'] ?> </a>
              </div>
                  ...
                  <div class="card-body">
                    <form method="post">
                      ...
                      <div class="form-group row mb-4">
                        <label class="
                            col-form-label text-md-right col-12 col-md-3 col-lg-3">Title</label>
                        <div class="col-sm-12 col-md-7">
                          <input type="text" name="name" value="<?= $knowledge['name'] ?>" class="form-control" />
                        </div>
                      </div>
                      <div class="form-group row mb-4">
                        <label class="
                            col-form-label text-md-right col-12 col-md-3 col-lg-3">Content</label>
                        <div class="col-sm-12 col-md-7">
                          <textarea name="text" class="summernote"><?= $knowledge['text'] ?></textarea>
                        </div>
                      </div>
                      <div class="form-group row mb-4">
